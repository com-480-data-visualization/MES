...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function gc(e,t,n){let r=new Float32Array(nc),i=new W(0,1,0);return new oo({name:`SphericalGaussianBlur`,defines:{n:nc,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:yc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function _c(){return new oo({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:yc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vc(){return new oo({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:yc(),fragmentShader:`
	...
	`}var bc=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1};this.texture=new xa([n,n,n,n,n,n]),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`)}var Gl={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Kl(e,t){let n=Gl[t];return n===void 0?(z(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var ql=new W;function Jl(){return K.getLuminanceCoefficients(ql),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${ql.x.toFixed(4)}, ${ql.y.toFixed(4)}, ${ql.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
void main() {
	...
	if ( coord.x >= 1.0 ) {
		...
		}`};var Rd=class extends J{constructor(){super();let e=new Ld;e.scale.setScalar(45e4),this.add(e);let t=e.material.uniforms;t.turbidity.value=10,t.rayleigh.value=2,t.mieCoefficient.value=.005,t.mieDirectionalG.value=.8;let n=new cs(16777215,1);n.position.set(100,100,100),this.add(n),e.material.uniforms.sunPosition.value.copy(n.position)}};function zd(e){let t=new Fd;e.add(t);let n=new Rd;e.add(n);let r=new Id(100,10);return e.add(r),{building:t,tile:r,sky:n}}function Bd(e,t){window.addEventListener(`resize`,()=>{e.aspect=window.innerWidth/window.innerHeight,e.updateProjectionMatrix(),t.setSize(window.innerWidth,window.innerHeight)})}function Vd(e){let t=new Fs,n=new U;function r(r,i){n.x=r.clientX/window.innerWidth*2-1,n.y=-(r.clientY/window.innerHeight)*2+1,t.setFromCamera(n,e);let a=t.intersectObjects(i,!0);if(a.length>0){let e=a[0].object;for(;e&&!e.onClick;)e=e.parent;e?.onClick&&e.onClick()}}return r}function Hd(e,t){return Bd(e,t),Vd(e)}var Ud={min:0,marker:0,steps:1,visibleTicks:25},Wd=document.getElementById(`ruler`),Gd=[];function Kd(){Wd.innerHTML=``;for(let e=0;e<Ud.visibleTicks;e++){let t=document.createElement(`div`);t.style.width=Wd.clientWidth/(Ud.visibleTicks-2)+`px`,t.style.borderLeft=`1px solid black`,t.style.height=`50px`,t.style.boxSizing=`border-box`,t.style.textAlign=`center`,t.style.fontSize=`12px`,t.textContent=e,Wd.appendChild(t),Gd.push(t)}}function qd(){let e=Gd.shift();Ud.marker++,e.textContent=Ud.marker+Ud.visibleTicks-1,Wd.appendChild(e),Gd.push(e)}function Jd(){Ud.marker=0,Kd(),setInterval(qd,1e3)}function Yd(e,t){if(t===0)return console.warn(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Geometry already defined as triangles.`),e;if(t===2||t===1){let n=e.getIndex();if(n===null){let t=[],r=e.getAttribute(`position`);if(r!==void 0){for(let e=0;e<r.count;e++)t.push(e);e.setIndex(t),n=e.getIndex()}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Undefined position attribute. Processing not possible.`),e}let r=n.count-2,i=[];if(t===2)for(let e=1;e<=r;e++)i.push(n.getX(0)),i.push(n.getX(e)),i.push(n.getX(e+1));else for(let e=0;e<r;e++)e%2==0?(i.push(n.getX(e)),i.push(n.getX(e+1)),i.push(n.getX(e+2))):(i.push(n.getX(e+2)),i.push(n.getX(e+1)),i.push(n.getX(e)));i.length/3!==r&&console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unable to generate correct amount of triangles.`);let a=e.clone();return a.setIndex(i),a.clearGroups(),a}else return console.error(`THREE.BufferGeometryUtils.toTrianglesDrawMode(): Unknown draw mode:`,t),e}function Xd(e){let t=new Map,n=new Map,r=e.clone();return Zd(e,r,function(e,r){t.set(r,e),n.set(e,r)}),r.traverse(function(e){if(!e.isSkinnedMesh)return;let r=e,i=t.get(e),a=i.skeleton.bones;r.skeleton=i.skeleton.clone(),r.bindMatrix.copy(i.bindMatrix),r.skeleton.bones=a.map(function(e){return n.get(e)}),r.bind(r.skeleton,r.bindMatrix)}),r}function Zd(e,t,n){n(e,t);for(let r=0;r<e.children.length;r++)Zd(e.children[r],t.children[r],n)}var Qd=class extends Io{constructor(e){super(e),this.dracoLoader=null,this.ktx2Loader=null,this.meshoptDecoder=null,this.pluginCallbacks=[],this.register(function(e){return new af(e)}),this.register(function(e){return new of(e)}),this.register(function(e){return new hf(e)}),this.register(function(e){return new gf(e)}),this.register(function(e){return new _f(e)}),this.register(function(e){return new cf(e)}),this.register(function(e){return new lf(e)}),this.register(function(e){return new uf(e)}),this.register(function(e){return new df(e)}),this.register(function(e){return new rf(e)}),this.register(function(e){return new ff(e)}),this.register(function(e){return new sf(e)}),this.register(function(e){return new mf(e)}),this.register(function(e){return new pf(e)}),this.register(function(e){return new tf(e)}),this.register(function(e){return new vf(e,$.EXT_MESHOPT_COMPRESSION)}),this.register(function(e){return new vf(e,$.KHR_MESHOPT_COMPRESSION)}),this.register(function(e){return new yf(e)})}load(e,t,n,r){let i=this,a;if(this.resourcePath!==``)a=this.resourcePath;else if(this.path!==``){let t=ls.extractUrlBase(e);a=ls.resolveURL(t,this.path)}else a=ls.extractUrlBase(e);this.manager.itemStart(e);let o=function(t){r?r(t):console.error(t),i.manager.itemError(e),i.manager.itemEnd(e)},s=new zo(this.manager);s.setPath(this.path),s.setResponseType(`arraybuffer`),s.setRequestHeader(this.requestHeader),s.setWithCredentials(this.withCredentials),s.load(e,function(n){try{i.parse(n,a,function(n){t(n),i.manager.itemEnd(e)},o)}catch(e){o(e)}},n,o)}setDRACOLoader(e){return this.dracoLoader=e,this}setKTX2Loader(e){return this.ktx2Loader=e,this}setMeshoptDecoder(e){return this.meshoptDecoder=e,this}register(e){return this.pluginCallbacks.indexOf(e)===-1&&this.pluginCallbacks.push(e),this}unregister(e){return this.pluginCallbacks.indexOf(e)!==-1&&this.pluginCallbacks.splice(this.pluginCallbacks.indexOf(e),1),this}parse(e,t,n,r){let i,a={},o={},s=new TextDecoder;if(typeof e==`string`)i=JSON.parse(e);else if(e instanceof ArrayBuffer)if(s.decode(new Uint8Array(e,0,4))===bf){try{a[$.KHR_BINARY_GLTF]=new Cf(e)}catch(e){r&&r(e);return}i=JSON.parse(a[$.KHR_BINARY_GLTF].content)}else i=JSON.parse(s.decode(e));else i=e;if(i.asset===void 0||i.asset.version[0]<2){r&&r(Error(`THREE.GLTFLoader: Unsupported asset. glTF versions >=2.0 are supported.`));return}let c=new Yf(i,{path:t||this.resourcePath||``,crossOrigin:this.crossOrigin,requestHeader:this.requestHeader,manager:this.manager,ktx2Loader:this.ktx2Loader,meshoptDecoder:this.meshoptDecoder});c.fileLoader.setRequestHeader(this.requestHeader);for(let e=0;e<this.pluginCallbacks.length;e++){let t=this.pluginCallbacks[e](c);t.name||console.error(`THREE.GLTFLoader: Invalid plugin found: missing name`),o[t.name]=t,a[t.name]=!0}if(i.extensionsUsed)for(let e=0;e<i.extensionsUsed.length;++e){let t=i.extensionsUsed[e],n=i.extensionsRequired||[];switch(t){case $.KHR_MATERIALS_UNLIT:a[t]=new nf;break;case $.KHR_DRACO_MESH_COMPRESSION:a[t]=new wf(i,this.dracoLoader);break;case $.KHR_TEXTURE_TRANSFORM:a[t]=new Tf;break;case $.KHR_MESH_QUANTIZATION:a[t]=new Ef;break;default:n.indexOf(t)>=0&&o[t]===void 0&&console.warn(`THREE.GLTFLoader: Unknown extension "`+t+`".`)}}c.setExtensions(a),c.setPlugins(o),c.parse(n,r)}parseAsync(e,t){let n=this;return new Promise(function(r,i){n.parse(e,t,r,i)})}};function $d(){let e={};return{get:function(t){return e[t]},add:function(t,n){e[t]=n},remove:function(t){delete e[t]},removeAll:function(){e={}}}}function ef(e,t,n){let r=e.json.materials[t];return r.extensions&&r.extensions[n]?r.extensions[n]:null}var $={KHR_BINARY_GLTF:`KHR_binary_glTF`,KHR_DRACO_MESH_COMPRESSION:`KHR_draco_mesh_compression`,KHR_LIGHTS_PUNCTUAL:`KHR_lights_punctual`,KHR_MATERIALS_CLEARCOAT:`KHR_materials_clearcoat`,KHR_MATERIALS_DISPERSION:`KHR_materials_dispersion`,KHR_MATERIALS_IOR:`KHR_materials_ior`,KHR_MATERIALS_SHEEN:`KHR_materials_sheen`,KHR_MATERIALS_SPECULAR:`KHR_materials_specular`,KHR_MATERIALS_TRANSMISSION:`KHR_materials_transmission`,KHR_MATERIALS_IRIDESCENCE:`KHR_materials_iridescence`,KHR_MATERIALS_ANISOTROPY:`KHR_materials_anisotropy`,KHR_MATERIALS_UNLIT:`KHR_materials_unlit`,KHR_MATERIALS_VOLUME:`KHR_materials_volume`,KHR_TEXTURE_BASISU:`KHR_texture_basisu`,KHR_TEXTURE_TRANSFORM:`KHR_texture_transform`,KHR_MESH_QUANTIZATION:`KHR_mesh_quantization`,KHR_MATERIALS_EMISSIVE_STRENGTH:`KHR_materials_emissive_strength`,EXT_MATERIALS_BUMP:`EXT_materials_bump`,EXT_TEXTURE_WEBP:`EXT_texture_webp`,EXT_TEXTURE_AVIF:`EXT_texture_avif`,EXT_MESHOPT_COMPRESSION:`EXT_meshopt_compression`,KHR_MESHOPT_COMPRESSION:`KHR_meshopt_compression`,EXT_MESH_GPU_INSTANCING:`EXT_mesh_gpu_instancing`},tf=class{constructor(e){this.parser=e,this.name=$.KHR_LIGHTS_PUNCTUAL,this.cache={refs:{},uses:{}}}_markDefs(){let e=this.parser,t=this.parser.json.nodes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n];r.extensions&&r.extensions[this.name]&&r.extensions[this.name].light!==void 0&&e._addNodeRef(this.cache,r.extensions[this.name].light)}}_loadLight(e){let t=this.parser,n=`light:`+e,r=t.cache.get(n);if(r)return r;let i=t.json,a=((i.extensions&&i.extensions[this.name]||{}).lights||[])[e],o,s=new Y(16777215);a.color!==void 0&&s.setRGB(a.color[0],a.color[1],a.color[2],Ge);let c=a.range===void 0?0:a.range;switch(a.type){case`directional`:o=new cs(s),o.target.position.set(0,0,-1),o.add(o.target);break;case`point`:o=new as(s),o.distance=c;break;case`spot`:o=new rs(s),o.distance=c,a.spot=a.spot||{},a.spot.innerConeAngle=a.spot.innerConeAngle===void 0?0:a.spot.innerConeAngle,a.spot.outerConeAngle=a.spot.outerConeAngle===void 0?Math.PI/4:a.spot.outerConeAngle,o.angle=a.spot.outerConeAngle,o.penumbra=1-a.spot.innerConeAngle/a.spot.outerConeAngle,o.target.position.set(0,0,-1),o.add(o.target);break;default:throw Error(`THREE.GLTFLoader: Unexpected light type: `+a.type)}return o.position.set(0,0,0),Vf(o,a),a.intensity!==void 0&&(o.intensity=a.intensity),o.name=t.createUniqueName(a.name||`light_`+e),r=Promise.resolve(o),t.cache.add(n,r),r}getDependency(e,t){if(e===`light`)return this._loadLight(t)}createNodeAttachment(e){let t=this,n=this.parser,r=n.json.nodes[e],i=(r.extensions&&r.extensions[this.name]||{}).light;return i===void 0?null:this._loadLight(i).then(function(e){return n._getNodeRef(t.cache,i,e)})}},nf=class{constructor(){this.name=$.KHR_MATERIALS_UNLIT}getMaterialType(){return si}extendParams(e,t,n){let r=[];e.color=new Y(1,1,1),e.opacity=1;let i=t.pbrMetallicRoughness;if(i){if(Array.isArray(i.baseColorFactor)){let t=i.baseColorFactor;e.color.setRGB(t[0],t[1],t[2],Ge),e.opacity=t[3]}i.baseColorTexture!==void 0&&r.push(n.assignTexture(e,`map`,i.baseColorTexture,We))}return Promise.all(r)}},rf=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_EMISSIVE_STRENGTH}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);return n===null||n.emissiveStrength!==void 0&&(t.emissiveIntensity=n.emissiveStrength),Promise.resolve()}},af=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_CLEARCOAT}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(n.clearcoatFactor!==void 0&&(t.clearcoat=n.clearcoatFactor),n.clearcoatTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatMap`,n.clearcoatTexture)),n.clearcoatRoughnessFactor!==void 0&&(t.clearcoatRoughness=n.clearcoatRoughnessFactor),n.clearcoatRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`clearcoatRoughnessMap`,n.clearcoatRoughnessTexture)),n.clearcoatNormalTexture!==void 0&&(r.push(this.parser.assignTexture(t,`clearcoatNormalMap`,n.clearcoatNormalTexture)),n.clearcoatNormalTexture.scale!==void 0)){let e=n.clearcoatNormalTexture.scale;t.clearcoatNormalScale=new U(e,e)}return Promise.all(r)}},of=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_DISPERSION}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);return n===null||(t.dispersion=n.dispersion===void 0?0:n.dispersion),Promise.resolve()}},sf=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IRIDESCENCE}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.iridescenceFactor!==void 0&&(t.iridescence=n.iridescenceFactor),n.iridescenceTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceMap`,n.iridescenceTexture)),n.iridescenceIor!==void 0&&(t.iridescenceIOR=n.iridescenceIor),t.iridescenceThicknessRange===void 0&&(t.iridescenceThicknessRange=[100,400]),n.iridescenceThicknessMinimum!==void 0&&(t.iridescenceThicknessRange[0]=n.iridescenceThicknessMinimum),n.iridescenceThicknessMaximum!==void 0&&(t.iridescenceThicknessRange[1]=n.iridescenceThicknessMaximum),n.iridescenceThicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`iridescenceThicknessMap`,n.iridescenceThicknessTexture)),Promise.all(r)}},cf=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SHEEN}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];if(t.sheenColor=new Y(0,0,0),t.sheenRoughness=0,t.sheen=1,n.sheenColorFactor!==void 0){let e=n.sheenColorFactor;t.sheenColor.setRGB(e[0],e[1],e[2],Ge)}return n.sheenRoughnessFactor!==void 0&&(t.sheenRoughness=n.sheenRoughnessFactor),n.sheenColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenColorMap`,n.sheenColorTexture,We)),n.sheenRoughnessTexture!==void 0&&r.push(this.parser.assignTexture(t,`sheenRoughnessMap`,n.sheenRoughnessTexture)),Promise.all(r)}},lf=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_TRANSMISSION}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.transmissionFactor!==void 0&&(t.transmission=n.transmissionFactor),n.transmissionTexture!==void 0&&r.push(this.parser.assignTexture(t,`transmissionMap`,n.transmissionTexture)),Promise.all(r)}},uf=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_VOLUME}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.thickness=n.thicknessFactor===void 0?0:n.thicknessFactor,n.thicknessTexture!==void 0&&r.push(this.parser.assignTexture(t,`thicknessMap`,n.thicknessTexture)),t.attenuationDistance=n.attenuationDistance||1/0;let i=n.attenuationColor||[1,1,1];return t.attenuationColor=new Y().setRGB(i[0],i[1],i[2],Ge),Promise.all(r)}},df=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_IOR}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);return n===null||(t.ior=n.ior===void 0?1.5:n.ior),Promise.resolve()}},ff=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_SPECULAR}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];t.specularIntensity=n.specularFactor===void 0?1:n.specularFactor,n.specularTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularIntensityMap`,n.specularTexture));let i=n.specularColorFactor||[1,1,1];return t.specularColor=new Y().setRGB(i[0],i[1],i[2],Ge),n.specularColorTexture!==void 0&&r.push(this.parser.assignTexture(t,`specularColorMap`,n.specularColorTexture,We)),Promise.all(r)}},pf=class{constructor(e){this.parser=e,this.name=$.EXT_MATERIALS_BUMP}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return t.bumpScale=n.bumpFactor===void 0?1:n.bumpFactor,n.bumpTexture!==void 0&&r.push(this.parser.assignTexture(t,`bumpMap`,n.bumpTexture)),Promise.all(r)}},mf=class{constructor(e){this.parser=e,this.name=$.KHR_MATERIALS_ANISOTROPY}getMaterialType(e){return ef(this.parser,e,this.name)===null?null:lo}extendMaterialParams(e,t){let n=ef(this.parser,e,this.name);if(n===null)return Promise.resolve();let r=[];return n.anisotropyStrength!==void 0&&(t.anisotropy=n.anisotropyStrength),n.anisotropyRotation!==void 0&&(t.anisotropyRotation=n.anisotropyRotation),n.anisotropyTexture!==void 0&&r.push(this.parser.assignTexture(t,`anisotropyMap`,n.anisotropyTexture)),Promise.all(r)}},hf=class{constructor(e){this.parser=e,this.name=$.KHR_TEXTURE_BASISU}loadTexture(e){let t=this.parser,n=t.json,r=n.textures[e];if(!r.extensions||!r.extensions[this.name])return null;let i=r.extensions[this.name],a=t.options.ktx2Loader;if(!a){if(n.extensionsRequired&&n.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setKTX2Loader must be called before loading KTX2 textures`);return null}return t.loadTextureImage(e,i.source,a)}},gf=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_WEBP}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},_f=class{constructor(e){this.parser=e,this.name=$.EXT_TEXTURE_AVIF}loadTexture(e){let t=this.name,n=this.parser,r=n.json,i=r.textures[e];if(!i.extensions||!i.extensions[t])return null;let a=i.extensions[t],o=r.images[a.source],s=n.textureLoader;if(o.uri){let e=n.options.manager.getHandler(o.uri);e!==null&&(s=e)}return n.loadTextureImage(e,a.source,s)}},vf=class{constructor(e,t){this.name=t,this.parser=e}loadBufferView(e){let t=this.parser.json,n=t.bufferViews[e];if(n.extensions&&n.extensions[this.name]){let e=n.extensions[this.name],r=this.parser.getDependency(`buffer`,e.buffer),i=this.parser.options.meshoptDecoder;if(!i||!i.supported){if(t.extensionsRequired&&t.extensionsRequired.indexOf(this.name)>=0)throw Error(`THREE.GLTFLoader: setMeshoptDecoder must be called before loading compressed files`);return null}return r.then(function(t){let n=e.byteOffset||0,r=e.byteLength||0,a=e.count,o=e.byteStride,s=new Uint8Array(t,n,r);return i.decodeGltfBufferAsync?i.decodeGltfBufferAsync(a,o,s,e.mode,e.filter).then(function(e){return e.buffer}):i.ready.then(function(){let t=new ArrayBuffer(a*o);return i.decodeGltfBuffer(new Uint8Array(t),a,o,s,e.mode,e.filter),t})})}else return null}},yf=class{constructor(e){this.name=$.EXT_MESH_GPU_INSTANCING,this.parser=e}createNodeMesh(e){let t=this.parser.json,n=t.nodes[e];if(!n.extensions||!n.extensions[this.name]||n.mesh===void 0)return null;let r=t.meshes[n.mesh];for(let e of r.primitives)if(e.mode!==Af.TRIANGLES&&e.mode!==Af.TRIANGLE_STRIP&&e.mode!==Af.TRIANGLE_FAN&&e.mode!==void 0)return null;let i=n.extensions[this.name].attributes,a=[],o={};for(let e in i)a.push(this.parser.getDependency(`accessor`,i[e]).then(t=>(o[e]=t,o[e])));return a.length<1?null:(a.push(this.parser.createNodeMesh(e)),Promise.all(a).then(e=>{let t=e.pop(),n=t.isGroup?t.children:[t],r=e[0].count,i=[];for(let e of n){let t=new q,n=new W,a=new Pt,s=new W(1,1,1),c=new Gi(e.geometry,e.material,r);for(let e=0;e<r;e++)o.TRANSLATION&&n.fromBufferAttribute(o.TRANSLATION,e),o.ROTATION&&a.fromBufferAttribute(o.ROTATION,e),o.SCALE&&s.fromBufferAttribute(o.SCALE,e),c.setMatrixAt(e,t.compose(n,a,s));for(let t in o)if(t===`_COLOR_0`){let e=o[t];c.instanceColor=new Li(e.array,e.itemSize,e.normalized)}else t!==`TRANSLATION`&&t!==`ROTATION`&&t!==`SCALE`&&e.geometry.setAttribute(t,o[t]);J.prototype.copy.call(c,e),this.parser.assignFinalMaterial(c),i.push(c)}return t.isGroup?(t.clear(),t.add(...i),t):i[0]}))}},bf=`glTF`,xf=12,Sf={JSON:1313821514,BIN:5130562},Cf=class{constructor(e){this.name=$.KHR_BINARY_GLTF,this.content=null,this.body=null;let t=new DataView(e,0,xf),n=new TextDecoder;if(this.header={magic:n.decode(new Uint8Array(e.slice(0,4))),version:t.getUint32(4,!0),length:t.getUint32(8,!0)},this.header.magic!==bf)throw Error(`THREE.GLTFLoader: Unsupported glTF-Binary header.`);if(this.header.version<2)throw Error(`THREE.GLTFLoader: Legacy binary file detected.`);let r=this.header.length-xf,i=new DataView(e,xf),a=0;for(;a<r;){let t=i.getUint32(a,!0);a+=4;let r=i.getUint32(a,!0);if(a+=4,r===Sf.JSON){let r=new Uint8Array(e,xf+a,t);this.content=n.decode(r)}else if(r===Sf.BIN){let n=xf+a;this.body=e.slice(n,n+t)}a+=t}if(this.content===null)throw Error(`THREE.GLTFLoader: JSON content not found.`)}},wf=class{constructor(e,t){if(!t)throw Error(`THREE.GLTFLoader: No DRACOLoader instance provided.`);this.name=$.KHR_DRACO_MESH_COMPRESSION,this.json=e,this.dracoLoader=t,this.dracoLoader.preload()}decodePrimitive(e,t){let n=this.json,r=this.dracoLoader,i=e.extensions[this.name].bufferView,a=e.extensions[this.name].attributes,o={},s={},c={};for(let e in a){let t=Ff[e]||e.toLowerCase();o[t]=a[e]}for(let t in e.attributes){let r=Ff[t]||t.toLowerCase();if(a[t]!==void 0){let i=n.accessors[e.attributes[t]];c[r]=jf[i.componentType].name,s[r]=i.normalized===!0}}return t.getDependency(`bufferView`,i).then(function(e){return new Promise(function(t,n){r.decodeDracoFile(e,function(e){for(let t in e.attributes){let n=e.attributes[t],r=s[t];r!==void 0&&(n.normalized=r)}t(e)},o,c,Ge,n)})})}},Tf=class{constructor(){this.name=$.KHR_TEXTURE_TRANSFORM}extendTexture(e,t){return(t.texCoord===void 0||t.texCoord===e.channel)&&t.offset===void 0&&t.rotation===void 0&&t.scale===void 0?e:(e=e.clone(),t.texCoord!==void 0&&(e.channel=t.texCoord),t.offset!==void 0&&e.offset.fromArray(t.offset),t.rotation!==void 0&&(e.rotation=t.rotation),t.scale!==void 0&&e.repeat.fromArray(t.scale),e.needsUpdate=!0,e)}},Ef=class{constructor(){this.name=$.KHR_MESH_QUANTIZATION}},Df=class extends _o{constructor(e,t,n,r){super(e,t,n,r)}copySampleValue_(e){let t=this.resultBuffer,n=this.sampleValues,r=this.valueSize,i=e*r*3+r;for(let e=0;e!==r;e++)t[e]=n[i+e];return t}interpolate_(e,t,n,r){let i=this.resultBuffer,a=this.sampleValues,o=this.valueSize,s=o*2,c=o*3,l=r-t,u=(n-t)/l,d=u*u,f=d*u,p=e*c,m=p-c,h=-2*f+3*d,g=f-d,_=1-h,v=g-d+u;for(let e=0;e!==o;e++){let t=a[m+e+o],n=a[m+e+s]*l,r=a[p+e+o],c=a[p+e]*l;i[e]=_*t+v*n+h*r+g*c}return i}},Of=new Pt,kf=class extends Df{interpolate_(e,t,n,r){let i=super.interpolate_(e,t,n,r);return Of.fromArray(i).normalize().toArray(i),i}},Af={FLOAT:5126,FLOAT_MAT3:35675,FLOAT_MAT4:35676,FLOAT_VEC2:35664,FLOAT_VEC3:35665,FLOAT_VEC4:35666,LINEAR:9729,REPEAT:10497,SAMPLER_2D:35678,POINTS:0,LINES:1,LINE_LOOP:2,LINE_STRIP:3,TRIANGLES:4,TRIANGLE_STRIP:5,TRIANGLE_FAN:6,UNSIGNED_BYTE:5121,UNSIGNED_SHORT:5123},jf={5120:Int8Array,5121:Uint8Array,5122:Int16Array,5123:Uint16Array,5125:Uint32Array,5126:Float32Array},Mf={9728:o,9729:l,9984:s,9985:u,9986:c,9987:d},Nf={33071:i,33648:a,10497:r},Pf={SCALAR:1,VEC2:2,VEC3:3,VEC4:4,MAT2:4,MAT3:9,MAT4:16},Ff={POSITION:`position`,NORMAL:`normal`,TANGENT:`tangent`,TEXCOORD_0:`uv`,TEXCOORD_1:`uv1`,TEXCOORD_2:`uv2`,TEXCOORD_3:`uv3`,COLOR_0:`color`,WEIGHTS_0:`skinWeight`,JOINTS_0:`skinIndex`},If={scale:`scale`,translation:`position`,rotation:`quaternion`,weights:`morphTargetInfluences`},Lf={CUBICSPLINE:void 0,LINEAR:Fe,STEP:Pe},Rf={OPAQUE:`OPAQUE`,MASK:`MASK`,BLEND:`BLEND`};function zf(e){return e.DefaultMaterial===void 0&&(e.DefaultMaterial=new co({color:16777215,emissive:0,metalness:1,roughness:1,transparent:!1,depthTest:!0,side:0})),e.DefaultMaterial}function Bf(e,t,n){for(let r in n.extensions)e[r]===void 0&&(t.userData.gltfExtensions=t.userData.gltfExtensions||{},t.userData.gltfExtensions[r]=n.extensions[r])}function Vf(e,t){t.extras!==void 0&&(typeof t.extras==`object`?Object.assign(e.userData,t.extras):console.warn(`THREE.GLTFLoader: Ignoring primitive type .extras, `+t.extras))}function Hf(e,t,n){let r=!1,i=!1,a=!1;for(let e=0,n=t.length;e<n;e++){let n=t[e];if(n.POSITION!==void 0&&(r=!0),n.NORMAL!==void 0&&(i=!0),n.COLOR_0!==void 0&&(a=!0),r&&i&&a)break}if(!r&&!i&&!a)return Promise.resolve(e);let o=[],s=[],c=[];for(let l=0,u=t.length;l<u;l++){let u=t[l];if(r){let t=u.POSITION===void 0?e.attributes.position:n.getDependency(`accessor`,u.POSITION);o.push(t)}if(i){let t=u.NORMAL===void 0?e.attributes.normal:n.getDependency(`accessor`,u.NORMAL);s.push(t)}if(a){let t=u.COLOR_0===void 0?e.attributes.color:n.getDependency(`accessor`,u.COLOR_0);c.push(t)}}return Promise.all([Promise.all(o),Promise.all(s),Promise.all(c)]).then(function(t){let n=t[0],o=t[1],s=t[2];return r&&(e.morphAttributes.position=n),i&&(e.morphAttributes.normal=o),a&&(e.morphAttributes.color=s),e.morphTargetsRelative=!0,e})}function Uf(e,t){if(e.updateMorphTargets(),t.weights!==void 0)for(let n=0,r=t.weights.length;n<r;n++)e.morphTargetInfluences[n]=t.weights[n];if(t.extras&&Array.isArray(t.extras.targetNames)){let n=t.extras.targetNames;if(e.morphTargetInfluences.length===n.length){e.morphTargetDictionary={};for(let t=0,r=n.length;t<r;t++)e.morphTargetDictionary[n[t]]=t}else console.warn(`THREE.GLTFLoader: Invalid extras.targetNames length. Ignoring names.`)}}function Wf(e){let t,n=e.extensions&&e.extensions[$.KHR_DRACO_MESH_COMPRESSION];if(t=n?`draco:`+n.bufferView+`:`+n.indices+`:`+Gf(n.attributes):e.indices+`:`+Gf(e.attributes)+`:`+e.mode,e.targets!==void 0)for(let n=0,r=e.targets.length;n<r;n++)t+=`:`+Gf(e.targets[n]);return t}function Gf(e){let t=``,n=Object.keys(e).sort();for(let r=0,i=n.length;r<i;r++)t+=n[r]+`:`+e[n[r]]+`;`;return t}function Kf(e){switch(e){case Int8Array:return 1/127;case Uint8Array:return 1/255;case Int16Array:return 1/32767;case Uint16Array:return 1/65535;default:throw Error(`THREE.GLTFLoader: Unsupported normalized accessor component type.`)}}function qf(e){return e.search(/\.jpe?g($|\?)/i)>0||e.search(/^data\:image\/jpeg/)===0?`image/jpeg`:e.search(/\.webp($|\?)/i)>0||e.search(/^data\:image\/webp/)===0?`image/webp`:e.search(/\.ktx2($|\?)/i)>0||e.search(/^data\:image\/ktx2/)===0?`image/ktx2`:`image/png`}var Jf=new q,Yf=class{constructor(e={},t={}){this.json=e,this.extensions={},this.plugins={},this.options=t,this.cache=new $d,this.associations=new Map,this.primitiveCache={},this.nodeCache={},this.meshCache={refs:{},uses:{}},this.cameraCache={refs:{},uses:{}},this.lightCache={refs:{},uses:{}},this.sourceCache={},this.textureCache={},this.nodeNamesUsed={};let n=!1,r=-1,i=!1,a=-1;if(typeof navigator<`u`&&navigator.userAgent!==void 0){let e=navigator.userAgent;n=/^((?!chrome|android).)*safari/i.test(e)===!0;let t=e.match(/Version\/(\d+)/);r=n&&t?parseInt(t[1],10):-1,i=e.indexOf(`Firefox`)>-1,a=i?e.match(/Firefox\/([0-9]+)\./)[1]:-1}typeof createImageBitmap>`u`||n&&r<17||i&&a<98?this.textureLoader=new Ho(this.options.manager):this.textureLoader=new ds(this.options.manager),this.textureLoader.setCrossOrigin(this.options.crossOrigin),this.textureLoader.setRequestHeader(this.options.requestHeader),this.fileLoader=new zo(this.options.manager),this.fileLoader.setResponseType(`arraybuffer`),this.options.crossOrigin===`use-credentials`&&this.fileLoader.setWithCredentials(!0)}setExtensions(e){this.extensions=e}setPlugins(e){this.plugins=e}parse(e,t){let n=this,r=this.json,i=this.extensions;this.cache.removeAll(),this.nodeCache={},this._invokeAll(function(e){return e._markDefs&&e._markDefs()}),Promise.all(this._invokeAll(function(e){return e.beforeRoot&&e.beforeRoot()})).then(function(){return Promise.all([n.getDependencies(`scene`),n.getDependencies(`animation`),n.getDependencies(`camera`)])}).then(function(t){let a={scene:t[0][r.scene||0],scenes:t[0],animations:t[1],cameras:t[2],asset:r.asset,parser:n,userData:{}};return Bf(i,a,r),Vf(a,r),Promise.all(n._invokeAll(function(e){return e.afterRoot&&e.afterRoot(a)})).then(function(){for(let e of a.scenes)e.updateMatrixWorld();e(a)})}).catch(t)}_markDefs(){let e=this.json.nodes||[],t=this.json.skins||[],n=this.json.meshes||[];for(let n=0,r=t.length;n<r;n++){let r=t[n].joints;for(let t=0,n=r.length;t<n;t++)e[r[t]].isBone=!0}for(let t=0,r=e.length;t<r;t++){let r=e[t];r.mesh!==void 0&&(this._addNodeRef(this.meshCache,r.mesh),r.skin!==void 0&&(n[r.mesh].isSkinnedMesh=!0)),r.camera!==void 0&&this._addNodeRef(this.cameraCache,r.camera)}}_addNodeRef(e,t){t!==void 0&&(e.refs[t]===void 0&&(e.refs[t]=e.uses[t]=0),e.refs[t]++)}_getNodeRef(e,t,n){if(e.refs[t]<=1)return n;let r=n.clone(),i=(e,t)=>{let n=this.associations.get(e);n!=null&&this.associations.set(t,n);for(let[n,r]of e.children.entries())i(r,t.children[n])};return i(n,r),r.name+=`_instance_`+ e.uses[t]++,r}_invokeOne(e){let t=Object.values(this.plugins);t.push(this);for(let n=0;n<t.length;n++){let r=e(t[n]);if(r)return r}return null}_invokeAll(e){let t=Object.values(this.plugins);t.unshift(this);let n=[];for(let r=0;r<t.length;r++){let i=e(t[r]);i&&n.push(i)}return n}getDependency(e,t){let n=e+`:`+t,r=this.cache.get(n);if(!r){switch(e){case`scene`:r=this.loadScene(t);break;case`node`:r=this._invokeOne(function(e){return e.loadNode&&e.loadNode(t)});break;case`mesh`:r=this._invokeOne(function(e){return e.loadMesh&&e.loadMesh(t)});break;case`accessor`:r=this.loadAccessor(t);break;case`bufferView`:r=this._invokeOne(function(e){return e.loadBufferView&&e.loadBufferView(t)});break;case`buffer`:r=this.loadBuffer(t);break;case`material`:r=this._invokeOne(function(e){return e.loadMaterial&&e.loadMaterial(t)});break;case`texture`:r=this._invokeOne(function(e){return e.loadTexture&&e.loadTexture(t)});break;case`skin`:r=this.loadSkin(t);break;case`animation`:r=this._invokeOne(function(e){return e.loadAnimation&&e.loadAnimation(t)});break;case`camera`:r=this.loadCamera(t);break;default:if(r=this._invokeOne(function(n){return n!=this&&n.getDependency&&n.getDependency(e,t)}),!r)throw Error(`Unknown type: `+e);break}this.cache.add(n,r)}return r}getDependencies(e){let t=this.cache.get(e);if(!t){let n=this,r=this.json[e+(e===`mesh`?`es`:`s`)]||[];t=Promise.all(r.map(function(t,r){return n.getDependency(e,r)})),this.cache.add(e,t)}return t}loadBuffer(e){let t=this.json.buffers[e],n=this.fileLoader;if(t.type&&t.type!==`arraybuffer`)throw Error(`THREE.GLTFLoader: `+t.type+` buffer type is not supported.`);if(t.uri===void 0&&e===0)return Promise.resolve(this.extensions[$.KHR_BINARY_GLTF].body);let r=this.options;return new Promise(function(e,i){n.load(ls.resolveURL(t.uri,r.path),e,void 0,function(){i(Error(`THREE.GLTFLoader: Failed to load buffer "`+t.uri+`".`))})})}loadBufferView(e){let t=this.json.bufferViews[e];return this.getDependency(`buffer`,t.buffer).then(function(e){let n=t.byteLength||0,r=t.byteOffset||0;return e.slice(r,r+n)})}loadAccessor(e){let t=this,n=this.json,r=this.json.accessors[e];if(r.bufferView===void 0&&r.sparse===void 0){let e=Pf[r.type],t=jf[r.componentType],n=r.normalized===!0,i=new t(r.count*e);return Promise.resolve(new gr(i,e,n))}let i=[];return r.bufferView===void 0?i.push(null):i.push(this.getDependency(`bufferView`,r.bufferView)),r.sparse!==void 0&&(i.push(this.getDependency(`bufferView`,r.sparse.indices.bufferView)),i.push(this.getDependency(`bufferView`,r.sparse.values.bufferView))),Promise.all(i).then(function(e){let i=e[0],a=Pf[r.type],o=jf[r.componentType],s=o.BYTES_PER_ELEMENT,c=s*a,l=r.byteOffset||0,u=r.bufferView===void 0?void 0:n.bufferViews[r.bufferView].byteStride,d=r.normalized===!0,f,p;if(u&&u!==c){let e=Math.floor(l/u),n=`InterleavedBuffer:`+r.bufferView+`:`+r.componentType+`:`+e+`:`+r.count,c=t.cache.get(n);c||(f=new o(i,e*u,r.count*u/s),c=new Mr(f,u/s),t.cache.add(n,c)),p=new Pr(c,a,l%u/s,d)}else f=i===null?new o(r.count*a):new o(i,l,r.count*a),p=new gr(f,a,d);if(r.sparse!==void 0){let t=Pf.SCALAR,n=jf[r.sparse.indices.componentType],s=r.sparse.indices.byteOffset||0,c=r.sparse.values.byteOffset||0,l=new n(e[1],s,r.sparse.count*t),u=new o(e[2],c,r.sparse.count*a);i!==null&&(p=new gr(p.array.slice(),p.itemSize,p.normalized)),p.normalized=!1;for(let e=0,t=l.length;e<t;e++){let t=l[e];if(p.setX(t,u[e*a]),a>=2&&p.setY(t,u[e*a+1]),a>=3&&p.setZ(t,u[e*a+2]),a>=4&&p.setW(t,u[e*a+3]),a>=5)throw Error(`THREE.GLTFLoader: Unsupported itemSize in sparse BufferAttribute.`)}p.normalized=d}return p})}loadTexture(e){let t=this.json,n=this.options,r=t.textures[e].source,i=t.images[r],a=this.textureLoader;if(i.uri){let e=n.manager.getHandler(i.uri);e!==null&&(a=e)}return this.loadTextureImage(e,r,a)}loadTextureImage(e,t,n){let r=this,i=this.json,a=i.textures[e],o=i.images[t],s=(o.uri||o.bufferView)+`:`+a.sampler;if(this.textureCache[s])return this.textureCache[s];let c=this.loadImageSource(t,n).then(function(t){t.flipY=!1,t.name=a.name||o.name||``,t.name===``&&typeof o.uri==`string`&&o.uri.startsWith(`data:image/`)===!1&&(t.name=o.uri);let n=(i.samplers||{})[a.sampler]||{};return t.magFilter=Mf[n.magFilter]||1006,t.minFilter=Mf[n.minFilter]||1008,t.wrapS=Nf[n.wrapS]||1e3,t.wrapT=Nf[n.wrapT]||1e3,t.generateMipmaps=!t.isCompressedTexture&&t.minFilter!==1003&&t.minFilter!==1006,r.associations.set(t,{textures:e}),t}).catch(function(){return null});return this.textureCache[s]=c,c}loadImageSource(e,t){let n=this,r=this.json,i=this.options;if(this.sourceCache[e]!==void 0)return this.sourceCache[e].then(e=>e.clone());let a=r.images[e],o=self.URL||self.webkitURL,s=a.uri||``,c=!1;if(a.bufferView!==void 0)s=n.getDependency(`bufferView`,a.bufferView).then(function(e){c=!0;let t=new Blob([e],{type:a.mimeType});return s=o.createObjectURL(t),s});else if(a.uri===void 0)throw Error(`THREE.GLTFLoader: Image `+e+` is missing URI and bufferView`);let l=Promise.resolve(s).then(function(e){return new Promise(function(n,r){let a=n;t.isImageBitmapLoader===!0&&(a=function(e){let t=new Xt(e);t.needsUpdate=!0,n(t)}),t.load(ls.resolveURL(e,i.path),a,void 0,r)})}).then(function(e){return c===!0&&o.revokeObjectURL(s),Vf(e,a),e.userData.mimeType=a.mimeType||qf(a.uri),e}).catch(function(e){throw console.error(`THREE.GLTFLoader: Couldn't load texture`,s),e});return this.sourceCache[e]=l,l}assignTexture(e,t,n,r){let i=this;return this.getDependency(`texture`,n.index).then(function(a){if(!a)return null;if(n.texCoord!==void 0&&n.texCoord>0&&(a=a.clone(),a.channel=n.texCoord),i.extensions[$.KHR_TEXTURE_TRANSFORM]){let e=n.extensions===void 0?void 0:n.extensions[$.KHR_TEXTURE_TRANSFORM];if(e){let t=i.associations.get(a);a=i.extensions[$.KHR_TEXTURE_TRANSFORM].extendTexture(a,e),i.associations.set(a,t)}}return r!==void 0&&(a.colorSpace=r),e[t]=a,a})}assignFinalMaterial(e){let t=e.geometry,n=e.material,r=t.attributes.tangent===void 0,i=t.attributes.color!==void 0,a=t.attributes.normal===void 0;if(e.isPoints){let e=`PointsMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ma,Ir.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,t.sizeAttenuation=!1,this.cache.add(e,t)),n=t}else if(e.isLine){let e=`LineBasicMaterial:`+n.uuid,t=this.cache.get(e);t||(t=new ea,Ir.prototype.copy.call(t,n),t.color.copy(n.color),t.map=n.map,this.cache.add(e,t)),n=t}if(r||i||a){let e=`ClonedMaterial:`+n.uuid+`:`;r&&(e+=`derivative-tangents:`),i&&(e+=`vertex-colors:`),a&&(e+=`flat-shading:`);let t=this.cache.get(e);t||(t=n.clone(),i&&(t.vertexColors=!0),a&&(t.flatShading=!0),r&&(t.normalScale&&(t.normalScale.y*=-1),t.clearcoatNormalScale&&(t.clearcoatNormalScale.y*=-1)),this.cache.add(e,t),this.associations.set(t,this.associations.get(n))),n=t}e.material=n}getMaterialType(){return co}loadMaterial(e){let t=this,n=this.json,r=this.extensions,i=n.materials[e],a,o={},s=i.extensions||{},c=[];if(s[$.KHR_MATERIALS_UNLIT]){let e=r[$.KHR_MATERIALS_UNLIT];a=e.getMaterialType(),c.push(e.extendParams(o,i,t))}else{let n=i.pbrMetallicRoughness||{};if(o.color=new Y(1,1,1),o.opacity=1,Array.isArray(n.baseColorFactor)){let e=n.baseColorFactor;o.color.setRGB(e[0],e[1],e[2],Ge),o.opacity=e[3]}n.baseColorTexture!==void 0&&c.push(t.assignTexture(o,`map`,n.baseColorTexture,We)),o.metalness=n.metallicFactor===void 0?1:n.metallicFactor,o.roughness=n.roughnessFactor===void 0?1:n.roughnessFactor,n.metallicRoughnessTexture!==void 0&&(c.push(t.assignTexture(o,`metalnessMap`,n.metallicRoughnessTexture)),c.push(t.assignTexture(o,`roughnessMap`,n.metallicRoughnessTexture))),a=this._invokeOne(function(t){return t.getMaterialType&&t.getMaterialType(e)}),c.push(Promise.all(this._invokeAll(function(t){return t.extendMaterialParams&&t.extendMaterialParams(e,o)})))}i.doubleSided===!0&&(o.side=2);let l=i.alphaMode||Rf.OPAQUE;if(l===Rf.BLEND?(o.transparent=!0,o.depthWrite=!1):(o.transparent=!1,l===Rf.MASK&&(o.alphaTest=i.alphaCutoff===void 0?.5:i.alphaCutoff)),i.normalTexture!==void 0&&a!==si&&(c.push(t.assignTexture(o,`normalMap`,i.normalTexture)),o.normalScale=new U(1,1),i.normalTexture.scale!==void 0)){let e=i.normalTexture.scale;o.normalScale.set(e,e)}if(i.occlusionTexture!==void 0&&a!==si&&(c.push(t.assignTexture(o,`aoMap`,i.occlusionTexture)),i.occlusionTexture.strength!==void 0&&(o.aoMapIntensity=i.occlusionTexture.strength)),i.emissiveFactor!==void 0&&a!==si){let e=i.emissiveFactor;o.emissive=new Y().setRGB(e[0],e[1],e[2],Ge)}return i.emissiveTexture!==void 0&&a!==si&&c.push(t.assignTexture(o,`emissiveMap`,i.emissiveTexture,We)),Promise.all(c).then(function(){let n=new a(o);return i.name&&(n.name=i.name),Vf(n,i),t.associations.set(n,{materials:e}),i.extensions&&Bf(r,n,i),n})}createUniqueName(e){let t=As.sanitizeNodeName(e||``);return t in this.nodeNamesUsed?t+`_`+ ++this.nodeNamesUsed[t]:(this.nodeNamesUsed[t]=0,t)}loadGeometries(e){let t=this,n=this.extensions,r=this.primitiveCache;function i(e){return n[$.KHR_DRACO_MESH_COMPRESSION].decodePrimitive(e,t).then(function(n){return Zf(n,e,t)})}let a=[];for(let n=0,o=e.length;n<o;n++){let o=e[n],s=Wf(o),c=r[s];if(c)a.push(c.promise);else{let e;e=o.extensions&&o.extensions[$.KHR_DRACO_MESH_COMPRESSION]?i(o):Zf(new jr,o,t),r[s]={primitive:o,promise:e},a.push(e)}}return Promise.all(a)}loadMesh(e){let t=this,n=this.json,r=this.extensions,i=n.meshes[e],a=i.primitives,o=[];for(let e=0,t=a.length;e<t;e++){let t=a[e].material===void 0?zf(this.cache):this.getDependency(`material`,a[e].material);o.push(t)}return o.push(t.loadGeometries(a)),Promise.all(o).then(function(n){let o=n.slice(0,n.length-1),s=n[n.length-1],c=[];for(let n=0,l=s.length;n<l;n++){let l=s[n],u=a[n],d,f=o[n];if(u.mode===Af.TRIANGLES||u.mode===Af.TRIANGLE_STRIP||u.mode===Af.TRIANGLE_FAN||u.mode===void 0)d=i.isSkinnedMesh===!0?new ji(l,f):new yi(l,f),d.isSkinnedMesh===!0&&d.normalizeSkinWeights(),u.mode===Af.TRIANGLE_STRIP?d.geometry=Yd(d.geometry,1):u.mode===Af.TRIANGLE_FAN&&(d.geometry=Yd(d.geometry,2));else if(u.mode===Af.LINES)d=new fa(l,f);else if(u.mode===Af.LINE_STRIP)d=new ca(l,f);else if(u.mode===Af.LINE_LOOP)d=new pa(l,f);else if(u.mode===Af.POINTS)d=new ya(l,f);else throw Error(`THREE.GLTFLoader: Primitive mode unsupported: `+u.mode);Object.keys(d.geometry.morphAttributes).length>0&&Uf(d,i),d.name=t.createUniqueName(i.name||`mesh_`+e),Vf(d,i),u.extensions&&Bf(r,d,u),t.assignFinalMaterial(d),c.push(d)}for(let n=0,r=c.length;n<r;n++)t.associations.set(c[n],{meshes:e,primitives:n});if(c.length===1)return i.extensions&&Bf(r,c[0],i),c[0];let l=new kn;i.extensions&&Bf(r,l,i),t.associations.set(l,{meshes:e});for(let e=0,t=c.length;e<t;e++)l.add(c[e]);return l})}loadCamera(e){let t,n=this.json.cameras[e],r=n[n.type];if(!r){console.warn(`THREE.GLTFLoader: Missing camera parameters.`);return}return n.type===`perspective`?t=new ts(Nt.radToDeg(r.yfov),r.aspectRatio||1,r.znear||1,r.zfar||2e6):n.type===`orthographic`&&(t=new os(-r.xmag,r.xmag,r.ymag,-r.ymag,r.znear,r.zfar)),n.name&&(t.name=this.createUniqueName(n.name)),Vf(t,n),Promise.resolve(t)}loadSkin(e){let t=this.json.skins[e],n=[];for(let e=0,r=t.joints.length;e<r;e++)n.push(this._loadNodeShallow(t.joints[e]));return t.inverseBindMatrices===void 0?n.push(null):n.push(this.getDependency(`accessor`,t.inverseBindMatrices)),Promise.all(n).then(function(e){let n=e.pop(),r=e,i=[],a=[];for(let e=0,o=r.length;e<o;e++){let o=r[e];if(o){i.push(o);let t=new q;n!==null&&t.fromArray(n.array,e*16),a.push(t)}else console.warn(`THREE.GLTFLoader: Joint "%s" could not be found.`,t.joints[e])}return new Ii(i,a)})}loadAnimation(e){let t=this.json,n=this,r=t.animations[e],i=r.name?r.name:`animation_`+e,a=[],o=[],s=[],c=[],l=[];for(let e=0,t=r.channels.length;e<t;e++){let t=r.channels[e],n=r.samplers[t.sampler],i=t.target,u=i.node,d=r.parameters===void 0?n.input:r.parameters[n.input],f=r.parameters===void 0?n.output:r.parameters[n.output];i.node!==void 0&&(a.push(this.getDependency(`node`,u)),o.push(this.getDependency(`accessor`,d)),s.push(this.getDependency(`accessor`,f)),c.push(n),l.push(i))}return Promise.all([Promise.all(a),Promise.all(o),Promise.all(s),Promise.all(c),Promise.all(l)]).then(function(e){let t=e[0],a=e[1],o=e[2],s=e[3],c=e[4],l=[];for(let e=0,r=t.length;e<r;e++){let r=t[e],i=a[e],u=o[e],d=s[e],f=c[e];if(r===void 0)continue;r.updateMatrix&&r.updateMatrix();let p=n._createAnimationTracks(r,i,u,d,f);if(p)for(let e=0;e<p.length;e++)l.push(p[e])}let u=new Ao(i,void 0,l);return Vf(u,r),u})}createNodeMesh(e){let t=this.json,n=this,r=t.nodes[e];return r.mesh===void 0?null:n.getDependency(`mesh`,r.mesh).then(function(e){let t=n._getNodeRef(n.meshCache,r.mesh,e);return r.weights!==void 0&&t.traverse(function(e){if(e.isMesh)for(let t=0,n=r.weights.length;t<n;t++)e.morphTargetInfluences[t]=r.weights[t]}),t})}loadNode(e){let t=this.json,n=this,r=t.nodes[e],i=n._loadNodeShallow(e),a=[],o=r.children||[];for(let e=0,t=o.length;e<t;e++)a.push(n.getDependency(`node`,o[e]));let s=r.skin===void 0?Promise.resolve(null):n.getDependency(`skin`,r.skin);return Promise.all([i,Promise.all(a),s]).then(function(e){let t=e[0],n=e[1],r=e[2];r!==null&&t.traverse(function(e){e.isSkinnedMesh&&e.bind(r,Jf)});for(let e=0,r=n.length;e<r;e++)t.add(n[e]);if(t.userData.pivot!==void 0&&n.length>0){let e=t.userData.pivot,r=n[0];t.pivot=new W().fromArray(e),t.position.x-=e[0],t.position.y-=e[1],t.position.z-=e[2],r.position.set(0,0,0),delete t.userData.pivot}return t})}_loadNodeShallow(e){let t=this.json,n=this.extensions,r=this;if(this.nodeCache[e]!==void 0)return this.nodeCache[e];let i=t.nodes[e],a=i.name?r.createUniqueName(i.name):``,o=[],s=r._invokeOne(function(t){return t.createNodeMesh&&t.createNodeMesh(e)});return s&&o.push(s),i.camera!==void 0&&o.push(r.getDependency(`camera`,i.camera).then(function(e){return r._getNodeRef(r.cameraCache,i.camera,e)})),r._invokeAll(function(t){return t.createNodeAttachment&&t.createNodeAttachment(e)}).forEach(function(e){o.push(e)}),this.nodeCache[e]=Promise.all(o).then(function(t){let o;if(o=i.isBone===!0?new Mi:t.length>1?new kn:t.length===1?t[0]:new J,o!==t[0])for(let e=0,n=t.length;e<n;e++)o.add(t[e]);if(i.name&&(o.userData.name=i.name,o.name=a),Vf(o,i),i.extensions&&Bf(n,o,i),i.matrix!==void 0){let e=new q;e.fromArray(i.matrix),o.applyMatrix4(e)}else i.translation!==void 0&&o.position.fromArray(i.translation),i.rotation!==void 0&&o.quaternion.fromArray(i.rotation),i.scale!==void 0&&o.scale.fromArray(i.scale);if(!r.associations.has(o))r.associations.set(o,{});else if(i.mesh!==void 0&&r.meshCache.refs[i.mesh]>1){let e=r.associations.get(o);r.associations.set(o,{...e})}return r.associations.get(o).nodes=e,o}),this.nodeCache[e]}loadScene(e){let t=this.extensions,n=this.json.scenes[e],r=this,i=new kn;n.name&&(i.name=r.createUniqueName(n.name)),Vf(i,n),n.extensions&&Bf(t,i,n);let a=n.nodes||[],o=[];for(let e=0,t=a.length;e<t;e++)o.push(r.getDependency(`node`,a[e]));return Promise.all(o).then(function(e){for(let t=0,n=e.length;t<n;t++){let n=e[t];n.parent===null?i.add(n):i.add(Xd(n))}return r.associations=(e=>{let t=new Map;for(let[e,n]of r.associations)(e instanceof Ir||e instanceof Xt)&&t.set(e,n);return e.traverse(e=>{let n=r.associations.get(e);n!=null&&t.set(e,n)}),t})(i),i})}_createAnimationTracks(e,t,n,r,i){let a=[],o=e.name?e.name:e.uuid,s=[];If[i.path]===If.weights?e.traverse(function(e){e.morphTargetInfluences&&s.push(e.name?e.name:e.uuid)}):s.push(o);let c;switch(If[i.path]){case If.weights:c=To;break;case If.rotation:c=Do;break;case If.translation:case If.scale:c=ko;break;default:switch(n.itemSize){case 1:c=To;break;default:c=ko;break}break}let l=r.interpolation===void 0?Fe:Lf[r.interpolation],u=this._getArrayFromAccessor(n);for(let e=0,n=s.length;e<n;e++){let n=new c(s[e]+`.`+If[i.path],t.array,u,l);r.interpolation===`CUBICSPLINE`&&this._createCubicSplineTrackInterpolant(n),a.push(n)}return a}_getArrayFromAccessor(e){let t=e.array;if(e.normalized){let e=Kf(t.constructor),n=new Float32Array(t.length);for(let r=0,i=t.length;r<i;r++)n[r]=t[r]*e;t=n}return t}_createCubicSplineTrackInterpolant(e){e.createInterpolant=function(e){return new(this instanceof Do?kf:Df)(this.times,this.values,this.getValueSize()/3,e)},e.createInterpolant.isInterpolantFactoryMethodGLTFCubicSpline=!0}};function Xf(e,t,n){let r=t.attributes,i=new Qn;if(r.POSITION!==void 0){let e=n.json.accessors[r.POSITION],t=e.min,a=e.max;if(t!==void 0&&a!==void 0){if(i.set(new W(t[0],t[1],t[2]),new W(a[0],a[1],a[2])),e.normalized){let t=Kf(jf[e.componentType]);i.min.multiplyScalar(t),i.max.multiplyScalar(t)}}else{console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`);return}}else return;let a=t.targets;if(a!==void 0){let e=new W,t=new W;for(let r=0,i=a.length;r<i;r++){let i=a[r];if(i.POSITION!==void 0){let r=n.json.accessors[i.POSITION],a=r.min,o=r.max;if(a!==void 0&&o!==void 0){if(t.setX(Math.max(Math.abs(a[0]),Math.abs(o[0]))),t.setY(Math.max(Math.abs(a[1]),Math.abs(o[1]))),t.setZ(Math.max(Math.abs(a[2]),Math.abs(o[2]))),r.normalized){let e=Kf(jf[r.componentType]);t.multiplyScalar(e)}e.max(t)}else console.warn(`THREE.GLTFLoader: Missing min/max properties for accessor POSITION.`)}}i.expandByVector(e)}e.boundingBox=i;let o=new Cr;i.getCenter(o.center),o.radius=i.min.distanceTo(i.max)/2,e.boundingSphere=o}function Zf(e,t,n){let r=t.attributes,i=[];function a(t,r){return n.getDependency(`accessor`,t).then(function(t){e.setAttribute(r,t)})}for(let t in r){let n=Ff[t]||t.toLowerCase();n in e.attributes||i.push(a(r[t],n))}if(t.indices!==void 0&&!e.index){let r=n.getDependency(`accessor`,t.indices).then(function(t){e.setIndex(t)});i.push(r)}return K.workingColorSpace!==`srgb-linear`&&`COLOR_0`in r&&console.warn(`THREE.GLTFLoader: Converting vertex colors from "srgb-linear" to "${K.workingColorSpace}" not supported.`),Vf(e,t),Xf(e,t,n),Promise.all(i).then(function(){return t.targets===void 0?e:Hf(e,t.targets,n)})}function Qf(e=$f()){let t=ep(e),n=tp(t),r={x:(n.minX+n.maxX)/2,y:2.5,z:(n.minZ+n.maxZ)/2},i=Math.random()*Math.PI*2,a=new W(r.x+50*Math.cos(i),r.y,r.z+50*Math.sin(i)),o=rp(t,n,r.y),s=new Za,c=np(n,4);if(!op(a,o.position,c))return s.add(new Ya(a,o.position)),s;let l=sp(a,c),u=cp(l,a,c,r.y),d=cp(o.side,o.position,c,r.y),f=lp(l,o.side,c,r.y);return dp(s,a,u),dp(s,u,f),dp(s,f,d),dp(s,d,o.position),s}function $f(){return[{x:-6,y:-6},{x:0,y:-6},{x:6,y:-6},{x:-6,y:0},{x:0,y:0},{x:6,y:0},{x:-6,y:6},{x:0,y:6},{x:6,y:6}]}function ep(e){return e.map(e=>({x:e.x,z:e.z??e.y}))}function tp(e){return e.reduce((e,t)=>({minX:Math.min(e.minX,t.x),maxX:Math.max(e.maxX,t.x),minZ:Math.min(e.minZ,t.z),maxZ:Math.max(e.maxZ,t.z)}),{minX:1/0,maxX:-1/0,minZ:1/0,maxZ:-1/0})}function np(e,t){return{minX:e.minX-t,maxX:e.maxX+t,minZ:e.minZ-t,maxZ:e.maxZ+t}}function rp(e,t,n){let r=ip(e,t),i=r[Math.floor(Math.random()*r.length)],a=3+Math.random()*3,o=(Math.random()-.5)*1.4,s=i.x+i.normal.x*a+i.tangent.x*o,c=i.z+i.normal.z*a+i.tangent.z*o;return{side:i.side,position:new W(s,n,c)}}function ip(e,t){let n=[];return e.forEach(e=>{e.x===t.minX&&n.push(ap(e,`left`)),e.x===t.maxX&&n.push(ap(e,`right`)),e.z===t.minZ&&n.push(ap(e,`back`)),e.z===t.maxZ&&n.push(ap(e,`front`))}),n}function ap(e,t){return{x:e.x,z:e.z,side:t,normal:{left:{x:-1,z:0},right:{x:1,z:0},back:{x:0,z:-1},front:{x:0,z:1}}[t],tangent:{left:{x:0,z:1},right:{x:0,z:1},back:{x:1,z:0},front:{x:1,z:0}}[t]}}function op(e,t,n){for(let r=0;r<=30;r++){let i=r/30,a=Nt.lerp(e.x,t.x,i),o=Nt.lerp(e.z,t.z,i);if(a>n.minX&&a<n.maxX&&o>n.minZ&&o<n.maxZ)return!0}return!1}function sp(e,t){return[{side:`left`,distance:t.minX-e.x},{side:`right`,distance:e.x-t.maxX},{side:`back`,distance:t.minZ-e.z},{side:`front`,distance:e.z-t.maxZ}].filter(e=>e.distance>0).sort((e,t)=>t.distance-e.distance)[0]?.side??`front`}function cp(e,t,n,r){return e===`left`?new W(n.minX,r,fp(t.z,n.minZ,n.maxZ)):e===`right`?new W(n.maxX,r,fp(t.z,n.minZ,n.maxZ)):e===`back`?new W(fp(t.x,n.minX,n.maxX),r,n.minZ):new W(fp(t.x,n.minX,n.maxX),r,n.maxZ)}function lp(e,t,n,r){return e===t?up(e,n,r):new W(e===`left`||t===`left`?n.minX:n.maxX,r,e===`back`||t===`back`?n.minZ:n.maxZ)}function up(e,t,n){return e===`left`?new W(t.minX,n,(t.minZ+t.maxZ)/2):e===`right`?new W(t.maxX,n,(t.minZ+t.maxZ)/2):e===`back`?new W((t.minX+t.maxX)/2,n,t.minZ):new W((t.minX+t.maxX)/2,n,t.maxZ)}function dp(e,t,n){t.distanceTo(n)>.001&&e.add(new Ya(t,n))}function fp(e,t,n){return Math.max(t,Math.min(n,e))}var pp=.15,mp=class extends J{constructor(e,t=`Unknown`){super(),this.mode=0,this.t=0,this.buildingCenter=this.getBuildingCenter(e),this.committerID=t,this.commiterID=t,this.committerLabel=null,this.loader=new Qd,this.url=`/MES/models/RobotExpressive.glb`,this.curve=Qf(e),this.c=0,this.setCommitterID(t)}async loadModel(){return new Promise((e,t)=>{this.loader.load(this.url,t=>{this.model=t.scene,this.gltf=t;let n=this.model.getObjectByName(`Head_3`);n&&n.material.color.set(Pd()),this.model.scale.set(1,1,1),this.add(this.model);let r=new Ns(this.model),i=t.animations[10];r.clipAction(i).play(),this.mixer=r,e(this)},void 0,t)})}update(e){switch(this.mode){case 0:this.goWork(e);return;case 1:this.work(e);return;case 2:this.returnWork(e);return;case 3:this.dance(e);return;default:return}}work(e){this.mixer&&this.mixer.update(e),this.faceBuilding(),this.c++,this.c>=1e3&&(this.c=0,this.mode=2,this.changeAnimation(6))}returnWork(e){this.t+=pp*-e,this.t<=0&&(this.t=0,this.mode=999,this.changeAnimation(0)),this.mixer&&this.mixer.update(e);let t=this.curve.getPoint(this.t);this.position.copy(t);let n=this.curve.getTangent(this.t).normalize().multiplyScalar(-1);this.lookAt(this.position.clone().add(n))}goWork(e){this.t+=pp*e,this.t>=1&&(this.t=1,this.mode=1,this.changeAnimation(5)),this.mixer&&this.mixer.update(e);let t=this.curve.getPoint(this.t);this.position.copy(t);let n=this.curve.getTangent(this.t).normalize();this.lookAt(this.position.clone().add(n))}dance(e){this.mixer&&this.mixer.update(e),this.c++,this.c>=500&&(this.c=0,this.mode=999)}onClick(){Ad(`Worker for ${this.committerID}`)}setCommitterID(e){this.committerID=e||`Unknown`,this.commiterID=this.committerID,this.committerLabel&&(this.remove(this.committerLabel),this.committerLabel.material.map.dispose(),this.committerLabel.material.dispose()),this.committerLabel=this.createCommitterLabel(this.committerID),this.add(this.committerLabel)}createCommitterLabel(e){let t=document.createElement(`canvas`),n=t.getContext(`2d`);n.font=`600 34px Arial`;let r=n.measureText(e).width;t.width=Math.ceil(r+36),t.height=54,n.font=`600 34px Arial`,n.textAlign=`center`,n.textBaseline=`middle`,n.fillStyle=`rgba(20, 24, 28, 0.78)`,n.roundRect(0,0,t.width,t.height,12),n.fill(),n.fillStyle=`#ffffff`,n.fillText(e,t.width/2,t.height/2);let i=new Sa(t);i.needsUpdate=!0;let a=new Zr(new Lr({map:i,transparent:!0,depthTest:!1})),o=t.width/t.height;return a.position.set(0,3.2,0),a.scale.set(1.4*o,1.4,1),a.renderOrder=10,a}faceBuilding(){this.lookAt(new W(this.buildingCenter.x,this.position.y,this.buildingCenter.z))}getBuildingCenter(e=[]){if(e.length===0)return{x:0,z:0};let t=e.reduce((e,t)=>{let n=t.z??t.y;return{minX:Math.min(e.minX,t.x),maxX:Math.max(e.maxX,t.x),minZ:Math.min(e.minZ,n),maxZ:Math.max(e.maxZ,n)}},{minX:1/0,maxX:-1/0,minZ:1/0,maxZ:-1/0});return{x:(t.minX+t.maxX)/2,z:(t.minZ+t.maxZ)/2}}changeAnimation(e){let t=this.gltf.animations[e],n=this.mixer.clipAction(t);this.mixer.stopAllAction(),n.reset(),n.play()}getMode(){return this.mode}};function hp(e,t,n,r){return e=e.filter(e=>e.getMode()>2?(t.remove(e),!1):(e.update(n),!0)),r.update(),e}var gp=document.getElementById(`welcomeOverlay`),_p=document.querySelectorAll(`.viz-ui`),vp=new W(27,9,29),yp=new W(35,2.5,43),bp=new W(42,34,48),xp=new W(0,2.5,0),Sp=yp.clone(),Cp={},wp=!1,Tp=0,Ep=3.2;function Dp(e,t,n,r){e.position.copy(n),Sp.copy(r),t.target.copy(r),e.lookAt(r)}function Op(e){return e*e*(3-2*e)}function kp(e,t){Tp=0,Dp(e,t,vp,yp),gp.classList.add(`is-leaving`)}function Ap(e){e.enabled=!0,e.target.copy(xp),Sp.copy(xp),gp.classList.add(`is-hidden`),_p.forEach(e=>e.classList.remove(`is-hidden`))}function jp(e,t,n,r){Cp.update(n),Cp.getMode()===1&&(Cp.mode=3,Cp.c=0,Cp.lookAt(27,2.5,29),Cp.changeAnimation(4)),Cp.getMode()===999&&(Cp.mode=0,Cp.t=0,Cp.changeAnimation(10))}function Mp(e,t,n,r,i){wp||(wp=!0,t.remove(Cp),kp(i,r)),Tp+=n;let a=Math.min(Tp/Ep,1),o=Op(a);return i.position.lerpVectors(vp,bp,o),Sp.lerpVectors(yp,xp,o),i.lookAt(Sp),a>=1&&(Ap(r),wp=!1),wp}async function Np(e,t,n){Cp=new mp,Cp.curve=new Fa([new W(49,2.5,27),new W(43,2.5,32),new W(36,2.5,36),new W(28,2.5,37)]),Cp.t=0,await Cp.loadModel(),Cp.scale.setScalar(1.15),wp=!1,e.add(Cp),t.position.copy(vp),t.lookAt(Sp),n.enabled=!1,n.target.copy(Sp),Dp(t,n,vp,yp)}var Pp=class e{constructor(e=null){this.token=e}async fetchCommit(e,t,n,r,i=void 0){let a=`https://api.github.com/repos/${e}/${t}/commits?per_page=${r}&page=${n}`,o=this.token?{Authorization:`token ${this.token}`}:{},s=await fetch(a,{headers:o,signal:i});if(!s.ok)throw Error(`GitHub request failed with ${s.status}: ${s.statusText}`);return await s.json()}async fetchAllCommits(e,t){let n=1,r=[];for(;;){let i=await this.fetchCommit(e,t,n,100);if(i.length===0)break;r=r.concat(i),n++}return r}async fetchCommitsIntoQueue(t,n,r,i={}){let a=i.perPage??100,o=1;try{for(;;){let s=await this.fetchCommit(t,n,o,a,i.signal);if(s.length===0)break;s.forEach(t=>r.enqueue(e.getCommitSummary(t))),o++}r.close()}catch(e){if(e.name===`AbortError`){r.close();return}r.fail(e)}}static getCommitSummary(e){let t=e.commit.author.name;return{sha:e.sha,committer:t,commiter:t,date:e.commit.author.date,message:e.commit.message}}static parseRepoUrl(e){let t=new URL(e.trim());if(t.hostname!==`github.com`)throw Error(`Please enter a github.com repository URL.`);let[n,r]=t.pathname.replace(/^\/+|\/+$/g,``).split(`/`);if(!n||!r)throw Error(`Please enter a URL like https://github.com/owner/repository.`);return{owner:n,repo:r.replace(/\.git$/,``)}}static groupCommitsByDay(e){let t={};return e.forEach(e=>{let n=new Date(e.commit.author.date).toISOString().split(`T`)[0];t[n]||(t[n]=[]),t[n].push({sha:e.sha,author:e.commit.author.name,message:e.commit.message})}),t}static groupCommitsByAuthor(e){let t={};return e.forEach(e=>{let n=e.commit.author.name;t[n]||(t[n]=[]),t[n].push({sha:e.sha,date:e.commit.author.date,message:e.commit.message})}),t}},Fp=class{constructor(){this.items=[],this.waitingConsumers=[],this.closed=!1,this.error=null}enqueue(e){if(this.closed)throw Error(`Cannot enqueue into a closed queue.`);let t=this.waitingConsumers.shift();if(t){t.resolve({value:e,done:!1});return}this.items.push(e)}close(){this.closed=!0,this.flushWaitingConsumers()}fail(e){this.closed=!0,this.error=e,this.flushWaitingConsumers()}next(){return this.items.length>0?Promise.resolve({value:this.items.shift(),done:!1}):this.error?Promise.reject(this.error):this.closed?Promise.resolve({value:void 0,done:!0}):new Promise((e,t)=>{this.waitingConsumers.push({resolve:e,reject:t})})}flushWaitingConsumers(){this.waitingConsumers.splice(0).forEach(({resolve:e,reject:t})=>{if(this.error){t(this.error);return}e({value:void 0,done:!0})})}[Symbol.asyncIterator](){return this}};async function Ip(e,t,n,r,i){await e.fetchCommitsIntoQueue(t,n,r,{signal:i})}async function Lp(e,t,n={},r={}){let i=new Map,a=r.commitDelay??350,o=0;try{for await(let r of e){if(!t())break;o++,n.onCommit?.(r,o);let e=Rp(r);i.has(e)||(i.set(e,[]),await n.onNewCommitter?.(r.committer,r));let s=i.get(e);s.push(r),n.onCommitterCommitsUpdated?.(r.committer,s,r),await zp(a)}t()&&n.onDone?.(o,i.size,i)}catch(e){t()&&n.onError?.(e)}}function Rp(e){return(e.committer||`Unknown`).trim().toLowerCase()}function zp(e){return new Promise(t=>setTimeout(t,e))}var Bp=class{constructor(e={}){this.callbacks=e,this.api=new Pp,this.activeJob=null}start(e){let{owner:t,repo:n}=Pp.parseRepoUrl(e);this.stop();let r=new Fp,i=new AbortController,a={id:crypto.randomUUID(),abortController:i};this.activeJob=a,this.callbacks.onRepoSelected?.(t,n),this.callbacks.onStatus?.(`Fetching commits for ${t}/${n}...`),Ip(this.api,t,n,r,i.signal),Lp(r,()=>this.activeJob?.id===a.id,{onCommit:(e,t)=>{this.callbacks.onCommit?.(e,t)},onNewCommitter:async(e,t)=>{await this.callbacks.onNewCommitter?.(e,t)},onDone:(e,t)=>{this.callbacks.onStatus?.(`Finished reading ${e} commits from ${t} committers.`)},onError:e=>{this.callbacks.onStatus?.(e.message)}})}stop(){this.activeJob&&=(this.activeJob.abortController.abort(),null)}},Vp=Ed(),Hp=Dd(),Up=Od(),Wp=kd(Hp,Up),Gp=zd(Vp),Kp=[],qp=new Bp({onRepoSelected:(e,t)=>{document.getElementById(`repoLabel`).textContent=`${e}/${t}`},onStatus:Ad,onCommit:(e,t)=>{let n=nm(e,t);console.log(n),Ad(n)},onNewCommitter:async e=>{await tm(e)}}),Jp=Hd(Hp,Up);window.addEventListener(`click`,e=>{Jp(e,[Gp.building,...Kp])},!1),document.getElementById(`repoForm`).addEventListener(`submit`,e=>{e.preventDefault(),em(e.target.repoUrl.value)&&(Xp=`transition`)});var Yp=new gs,Xp=`welcome`,Zp=!1;await Np(Vp,Hp,Wp);function Qp(){requestAnimationFrame(Qp);let e=Yp.update().getDelta();Xp===`welcome`?jp(Kp,Vp,e,Wp):Xp===`transition`?(Zp=Mp(Kp,Vp,e,Wp,Hp),Zp||(Xp=`visualization`)):Xp===`visualization`?Kp=hp(Kp,Vp,e,Wp):console.log(`error`),Gp.building.update(e),Up.render(Vp,Hp)}document.getElementById(`myButton`).addEventListener(`click`,$p);async function $p(){let e=new mp(Gp.building.getBaseCoordinates());await e.loadModel(),Vp.add(e),Kp.push(e)}function em(e){try{return qp.start(e),!0}catch(e){return document.getElementById(`repoUrl`).setCustomValidity(e.message),document.getElementById(`repoUrl`).reportValidity(),document.getElementById(`repoUrl`).setCustomValidity(``),!1}}async function tm(e){let t=new mp(Gp.building.getBaseCoordinates(),e);await t.loadModel(),Vp.add(t),Kp.push(t)}function nm(e,t){let n=e.sha.slice(0,7),r=e.message.split(`
`)[0];return`#${t} ${n} by ${e.committer}: ${r}`}Jd(),Qp();